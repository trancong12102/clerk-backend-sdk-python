...
class InstanceRestrictions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object", "allowlist", "blocklist", "block_email_subaddresses", "ignore_dots_for_gmail_addresses"]
    ...
    def object_validate_enum(cls, value):
        ...
        if value not in set(['instance_restrictions']):
            raise ValueError("must be one of enum values ('instance_restrictions')")
        return value
