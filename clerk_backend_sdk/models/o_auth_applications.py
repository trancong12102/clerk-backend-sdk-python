...
class OAuthApplications(BaseModel):
    ...
    total_count: StrictInt = Field(description="Total number of OAuth applications ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [OAuthApplication.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
