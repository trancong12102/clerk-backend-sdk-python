...
class BlocklistIdentifier(BaseModel):
    ...
    identifier: Optional[StrictStr] = Field(default=None, description="An email address, email domain, phone number or web3 wallet. ")
    ...
    __properties: ClassVar[List[str]] = ["object", "id", "identifier", "identifier_type", "instance_id", "created_at", "updated_at"]
    ...
    def object_validate_enum(cls, value):
        ...
        if value not in set(['blocklist_identifier']):
            raise ValueError("must be one of enum values ('blocklist_identifier')")
        return value
    ...
    def identifier_type_validate_enum(cls, value):
        ...
        if value not in set(['email_address', 'phone_number', 'web3_wallet']):
            raise ValueError("must be one of enum values ('email_address', 'phone_number', 'web3_wallet')")
        return value
