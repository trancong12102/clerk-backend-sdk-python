...
class CreateBlocklistIdentifierRequest(BaseModel):
    """
    CreateBlocklistIdentifierRequest
    """ # noqa: E501
    identifier: StrictStr = Field(description="The identifier to be added in the block-list. This can be an email address, a phone number or a web3 wallet.")
