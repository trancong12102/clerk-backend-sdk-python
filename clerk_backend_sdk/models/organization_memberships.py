...
class OrganizationMemberships(BaseModel):
    ...
    total_count: StrictInt = Field(description="Total number of organization memberships ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [OrganizationMembership.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
