...
class OAuthApplication(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object", "id", "instance_id", "name", "client_id", "public", "scopes", "callback_url", "authorize_url", "token_fetch_url", "user_info_url", "created_at", "updated_at"]
