...
class OrganizationInvitations(BaseModel):
    ...
    total_count: StrictInt = Field(description="Total number of organization invitations ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [OrganizationInvitation.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
