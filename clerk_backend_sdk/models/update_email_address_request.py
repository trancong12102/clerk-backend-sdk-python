...
class UpdateEmailAddressRequest(BaseModel):
    ...
    """ # noqa: E501
    verified: Optional[StrictBool] = Field(default=None, description="The email address will be marked as verified.")
    primary: Optional[StrictBool] = Field(default=None, description="Set this email address as the primary email address for the user.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["verified", "primary"]
