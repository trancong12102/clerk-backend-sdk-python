...
class ChangeProductionInstanceDomainRequest(BaseModel):
    """
    ChangeProductionInstanceDomainRequest
    """ # noqa: E501
    home_url: Optional[StrictStr] = Field(default=None, description="The new home URL of the production instance e.g. https://www.example.com")
    ...
    __properties: ClassVar[List[str]] = ["home_url", "is_secondary"]
