...
class UpdatePhoneNumberRequest(BaseModel):
    ...
    """ # noqa: E501
    verified: Optional[StrictBool] = Field(default=None, description="The phone number will be marked as verified.")
    primary: Optional[StrictBool] = Field(default=None, description="Set this phone number as the primary phone number for the user.")
    reserved_for_second_factor: Optional[StrictBool] = Field(default=None, description="Set this phone number as reserved for multi-factor authentication. The phone number must also be verified. If there are no other reserved second factors, the phone number will be set as the default second factor.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["verified", "primary", "reserved_for_second_factor"]
