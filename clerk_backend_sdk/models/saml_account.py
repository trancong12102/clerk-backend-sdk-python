...
class SAMLAccount(BaseModel):
    ...
    provider_user_id: Optional[StrictStr] = None
    public_metadata: Optional[Dict[str, Any]] = None
    verification: Optional[SAMLAccountVerification]
    __properties: ClassVar[List[str]] = ["id", "object", "provider", "active", "email_address", "first_name", "last_name", "provider_user_id", "public_metadata", "verification"]

    @field_validator('object')
    def object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['saml_account']):
            raise ValueError("must be one of enum values ('saml_account')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if provider_user_id (nullable) is None
        # and model_fields_set contains the field
        if self.provider_user_id is None and "provider_user_id" in self.model_fields_set:
            _dict['provider_user_id'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "verification": SAMLAccountVerification.from_dict(obj["verification"]) if obj.get("verification") is not None else None
        })
        return _obj
