...
class CreateSessionTokenFromTemplate200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["object", "jwt"]
    ...
    def object_validate_enum(cls, value):
        ...
        if value not in set(['token']):
            raise ValueError("must be one of enum values ('token')")
        return value
