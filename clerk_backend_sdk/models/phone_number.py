...
class PhoneNumber(BaseModel):
    ...
    reserved_for_second_factor: Optional[StrictBool] = None
    default_second_factor: Optional[StrictBool] = None
    reserved: StrictBool
    verification: Optional[PhoneNumberVerification]
    linked_to: List[IdentificationLink]
    backup_codes: Optional[List[StrictStr]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "object", "phone_number", "reserved_for_second_factor", "default_second_factor", "reserved", "verification", "linked_to", "backup_codes", "created_at", "updated_at"]

    @field_validator('object')
    def object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['phone_number']):
            raise ValueError("must be one of enum values ('phone_number')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "default_second_factor": obj.get("default_second_factor"),
            "reserved": obj.get("reserved"),
            "verification": PhoneNumberVerification.from_dict(obj["verification"]) if obj.get("verification") is not None else None,
