...
class Oauth(BaseModel):
    ...
    status: StrictStr
    strategy: StrictStr
    external_verification_redirect_url: Optional[StrictStr] = None
    ...
    def strategy_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['oauth_google', 'oauth_mock', 'oauth_custom_mock']):
            raise ValueError("must be one of enum values ('oauth_google', 'oauth_mock', 'oauth_custom_mock')")
        return value
