...
class Web3Wallet(BaseModel):
    ...
    web3_wallet: StrictStr
    verification: Optional[Web3WalletVerification]
    ...
    __properties: ClassVar[List[str]] = ["id", "object", "web3_wallet", "verification", "created_at", "updated_at"]

    @field_validator('object')
    def object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['web3_wallet']):
            raise ValueError("must be one of enum values ('web3_wallet')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "verification": Web3WalletVerification.from_dict(obj["verification"]) if obj.get("verification") is not None else None,
