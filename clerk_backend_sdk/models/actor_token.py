...
class ActorToken(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object", "id", "status", "user_id", "actor", "token", "url", "created_at", "updated_at"]

    @field_validator('object')
    def object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['actor_token']):
            raise ValueError("must be one of enum values ('actor_token')")
        return value
