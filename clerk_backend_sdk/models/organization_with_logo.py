...
class OrganizationWithLogo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object", "id", "name", "slug", "members_count", "max_allowed_memberships", "admin_delete_enabled", "public_metadata", "private_metadata", "created_by", "created_at", "updated_at", "logo_url", "image_url", "has_image"]
