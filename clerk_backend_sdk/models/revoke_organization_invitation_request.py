...
class RevokeOrganizationInvitationRequest(BaseModel):
    ...
    """ # noqa: E501
    requesting_user_id: StrictStr = Field(description="The ID of the user that revokes the invitation. Must be an administrator in the organization.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["requesting_user_id"]
