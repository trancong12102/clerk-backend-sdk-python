...
class TestingTokensApi:
    ...
    @validate_call
    async def create_testing_token(
        self,
        ...
        _param = self._create_testing_token_serialize(
    ...
    @validate_call
    async def create_testing_token_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def create_testing_token_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _create_testing_token_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
