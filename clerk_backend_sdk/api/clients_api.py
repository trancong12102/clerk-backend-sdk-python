...
class ClientsApi:
    ...
    @validate_call
    async def get_client_with_http_info(
        self,
        client_id: Annotated[StrictStr, Field(description="Client ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_client_without_preload_content(
        self,
        client_id: Annotated[StrictStr, Field(description="Client ID.")],
        _request_timeout: Union[
            None,
    ...
    def _get_client_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/clients/{client_id}',
    ...
    async def get_client_list(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /clients is deprecated.", DeprecationWarning)

        _param = self._get_client_list_serialize(
            limit=limit,
            offset=offset,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def get_client_list_with_http_info(
        self,
        limit: Annotated[Optional[Union[Annotated[float, Field(le=500, strict=True, ge=1)], Annotated[int, Field(le=500, strict=True, ge=1)]]], Field(description="Applies a limit to the number of results returned. Can be used for paginating the results together with `offset`.")] = None,
        offset: Annotated[Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]], Field(description="Skip the first `offset` results when paginating. Needs to be an integer greater or equal to zero. To be used in conjunction with `limit`.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_client_list_without_preload_content(
        self,
        limit: Annotated[Optional[Union[Annotated[float, Field(le=500, strict=True, ge=1)], Annotated[int, Field(le=500, strict=True, ge=1)]]], Field(description="Applies a limit to the number of results returned. Can be used for paginating the results together with `offset`.")] = None,
        offset: Annotated[Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]], Field(description="Skip the first `offset` results when paginating. Needs to be an integer greater or equal to zero. To be used in conjunction with `limit`.")] = None,
        _request_timeout: Union[
    ...
    def _get_client_list_serialize(
        self,
        limit,
        offset,
        _request_auth,
    ...
    async def verify_client(
        self,
        verify_client_request: Annotated[Optional[VerifyClientRequest], Field(description="Parameters.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param verify_client_request: Parameters.
        :type verify_client_request: VerifyClientRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._verify_client_serialize(
            verify_client_request=verify_client_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def verify_client_with_http_info(
        self,
        verify_client_request: Annotated[Optional[VerifyClientRequest], Field(description="Parameters.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def verify_client_without_preload_content(
        self,
        verify_client_request: Annotated[Optional[VerifyClientRequest], Field(description="Parameters.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _verify_client_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if verify_client_request is not None:
            _body_params = verify_client_request
