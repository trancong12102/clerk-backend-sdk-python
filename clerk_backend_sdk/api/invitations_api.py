...
class InvitationsApi:
    ...
    async def create_invitation(
        self,
        create_invitation_request: Annotated[Optional[CreateInvitationRequest], Field(description="Required parameters")] = None,
    ...
    async def list_invitations(
        ...
        status: Annotated[Optional[StrictStr], Field(description="Filter invitations based on their status")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def revoke_invitation(
        self,
        invitation_id: Annotated[StrictStr, Field(description="The ID of the invitation to be revoked")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param invitation_id: The ID of the invitation to be revoked (required)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RevokeInvitation200Response",
            '400': "ClerkErrors",
            '404': "ClerkErrors",
        }
        response_data = await self.api_client.call_api(
    ...
    async def revoke_invitation_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RevokeInvitation200Response]:
        """Revokes an invitation
    ...
    def _revoke_invitation_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/invitations/{invitation_id}/revoke',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
